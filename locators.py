...
class CoursePageLocators():
    ...
    START_LEARNING = (By.XPATH, "//span[text()='Start learning']/..")
    START_COURSE = (By.XPATH, "//span[text()='Start Course']/..")
    COMPLETE_LESSON = (By.XPATH, "//span[text()='Mark lesson as complete']/..")
    COMPLETED_LABEL = (By.XPATH, "//span[text()='COMPLETED']")
...
class PaymentLocators():
    ...
    FAST_EMAIL = (By.CSS_SELECTOR, "#email")
    FAST_PASSWORD = (By.CSS_SELECTOR, "#password")
    CREATE_ACCOUNT = (By.XPATH, "//span[text()='Create Account']/..")